...
public:
	...
	XMLConstHandle FirstChildElement( const char* name = nullptr ) const				{
	...
	XMLConstHandle LastChildElement( const char* name = nullptr ) const				{
	...
	XMLConstHandle PreviousSiblingElement( const char* name = nullptr ) const		{
	...
	XMLConstHandle NextSiblingElement( const char* name = nullptr ) const			{
